...
enum DssMessage {
    ...
    BBB_ICS_ISASCP("BBB_ICS_ISASCP", "Is the signed attribute: 'signing-certificate' present?"),
    ...
    BBB_SAV_DSCACRCC("BBB_SAV_DSCACRCC", "Does the 'Signing Certificate' attribute contain references only to the certificate chain?"),
