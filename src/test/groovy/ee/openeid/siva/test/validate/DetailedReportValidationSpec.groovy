...
class DetailedReportValidationSpec extends GenericSpecification {
    ...
    def "Given detailed report, then it includes signatures element and its sub-elements"() {
        ...
        SivaRequests.validate(RequestData.validationRequest("hellopades-lt-sha256-ec256.pdf", null, ReportType.DETAILED))
                ...
                .body("validationProcessBasicSignature.constraint.name.key", hasItem(DssMessage.BSV_IXCVRC.key))
                .body("validationProcessBasicSignature.constraint.name.key", hasItem(DssMessage.BSV_ICVRC.key))
                .body("validationProcessBasicSignature.constraint.name.key", hasItem(DssMessage.BSV_ISAVRC.key))
                ...
                .body("timestamps[0].validationProcessTimestamp.constraint.name.key", hasItem(DssMessage.BSV_IISCRC.key))
                .body("timestamps[0].validationProcessTimestamp.constraint.name.key", hasItem(DssMessage.BSV_IXCVRC.key))
                .body("timestamps[0].validationProcessTimestamp.constraint.name.key", hasItem(DssMessage.BSV_ICVRC.key))
                .body("timestamps[0].validationProcessTimestamp.constraint.name.key", hasItem(DssMessage.BSV_ISAVRC.key))
                ...
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.LTV_ABSV.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'LTV_ABSV'}.status", equalTo("OK"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.BBB_XCV_IRDPFC.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'BBB_XCV_IRDPFC'}.status", equalTo("OK"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.BBB_XCV_IARDPFC.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'BBB_XCV_IARDPFC'}.status", equalTo("OK"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.BBB_SAV_DMICTSTMCMI.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'BBB_SAV_DMICTSTMCMI'}.status", equalTo("OK"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.ADEST_IBSVPTC.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'ADEST_IBSVPTC'}.status", equalTo("OK"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.TSV_IBSTAIDOSC.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'ADEST_IBSVPTC'}.status", equalTo("OK"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.TSV_ASTPTCT.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'TSV_ASTPTCT'}.status", equalTo("OK"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.BBB_SAV_ISQPSTP.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'BBB_SAV_ISQPSTP'}.status", equalTo("OK"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.ADEST_ISTPTDABST.key))
                .body("validationProcessLongTermData.constraint.find {it.name.key == 'ADEST_ISTPTDABST'}.status", equalTo("IGNORED"))
                .body("validationProcessLongTermData.constraint.name.key", hasItem(DssMessage.BBB_SAV_ISVA.key))
                ...
                .body("validationProcessArchivalData.constraint.name.key", hasItem(DssMessage.ARCH_LTVV.key))
    ...
    def "Given detailed report, then it includes basicBuildingBlocks element, when type timestamp"() {
        ...
        response.then().rootPath(VALIDATION_PROCESS_PREFIX)
                ...
                .body("basicBuildingBlocks[1].CV.constraint.name.key", hasItems(DssMessage.BBB_CV_TSP_IRDOF.key, DssMessage.BBB_CV_TSP_IRDOI.key, DssMessage.BBB_CV_ISIT.key))
                ...
                .body("basicBuildingBlocks[1].SAV.constraint.name.key", hasItems(DssMessage.ACCM.key, DssMessage.BBB_ICS_ISASCP.key, DssMessage.BBB_SAV_DSCACRCC.key))
                .body("basicBuildingBlocks[1].SAV.constraint.status", Every.everyItem(equalTo("OK")))
                .body("basicBuildingBlocks[1].SAV.constraint[0].additionalInfo", is(emptyOrNullString()))
                .body("basicBuildingBlocks[1].SAV.conclusion.indication", equalTo(VALID_INDICATION_VALUE_PASSED))
                .body("basicBuildingBlocks[1].XCV.constraint.name.key", hasItems(DssMessage.BBB_XCV_CCCBB.key, DssMessage.BBB_XCV_SUB.key))
    ...
    def "Given detailed report, then it includes basicBuildingBlocks element, when type revocation"() {
        ...
        SivaRequests.validate(RequestData.validationRequest("pades-baseline-lta-live-aj.pdf", null, ReportType.DETAILED))
                .then().rootPath(VALIDATION_PROCESS_PREFIX)
                .body("basicBuildingBlocks[0].ISC.constraint.name.key", hasItem(DssMessage.BBB_ICS_ISCI.key))
                ...
                .body("basicBuildingBlocks[0].CV.constraint.name.key", hasItem(DssMessage.BBB_CV_ISIR.key))
                ...
                .body("basicBuildingBlocks[0].SAV.constraint.name.key", hasItem(DssMessage.ACCM.key))
                ...
                .body("basicBuildingBlocks[0].XCV.constraint.name.key", hasItems(DssMessage.BBB_XCV_CCCBB.key, DssMessage.BBB_XCV_SUB.key))
    ...
    def "Given detailed report, then it includes basicBuildingBlocks element, when type signature"() {
        ...
        SivaRequests.validate(RequestData.validationRequest("pades-baseline-lta-live-aj.pdf", null, ReportType.DETAILED))
                .then().rootPath(VALIDATION_PROCESS_PREFIX)
                .body("basicBuildingBlocks[3].ISC.constraint.name.key", hasItem(DssMessage.BBB_ICS_ISCI.key))
        ...
        //.body("basicBuildingBlocks[3].ISC.certificateChain.chainItem[0].source", equalTo("SIGNATURE"))
                ...
                .body("basicBuildingBlocks[3].CV.constraint.name.key", hasItem(DssMessage.BBB_CV_IRDOF.key))
                ...
                .body("basicBuildingBlocks[3].SAV.constraint.name.key", hasItems(DssMessage.BBB_SAV_ISSV.key, DssMessage.BBB_SAV_ISQPSTP.key, DssMessage.BBB_SAV_ISQPMDOSPP.key, DssMessage.ACCM.key))
                ...
                .body("basicBuildingBlocks[3].XCV.constraint.name.key", hasItems(DssMessage.BBB_XCV_CCCBB.key, DssMessage.BBB_XCV_SUB.key))
    ...
    def "Given detailed report, then it includes wrong signature value"() {
        ...
        SivaRequests.validate(RequestData.validationRequest("TS-02_23634_TS_wrong_SignatureValue.asice", null, ReportType.DETAILED))
                ...
                .body("validationProcessBasicSignature.constraint.name.key", hasItem(DssMessage.BSV_ISCRAVTC.key))
                .body("validationProcessBasicSignature.constraint.find { it.name.key == 'BSV_ISCRAVTC' }.status", equalTo("OK"))
                .body("validationProcessBasicSignature.constraint.name.key", hasItem(DssMessage.BSV_IVTAVRSC.key))
                ...
                .body("validationProcessBasicSignature.conclusion.errors.key", hasItem(DssMessage.BBB_XCV_SUB_ANS.key))
                .body("validationProcessBasicSignature.conclusion.errors.find { it.key == 'BBB_XCV_SUB_ANS' }.value", equalTo(DssMessage.BBB_XCV_SUB_ANS.message))
                .body("validationProcessBasicSignature.conclusion.errors.key", hasItem(DssMessage.BBB_XCV_ICTIVRSC_ANS.key))
                .body("validationProcessBasicSignature.conclusion.errors.find { it.key == 'BBB_XCV_ICTIVRSC_ANS' }.value", equalTo(DssMessage.BBB_XCV_ICTIVRSC_ANS.message))
                .body("validationProcessBasicSignature.conclusion.errors.key", hasItem(DssMessage.BBB_CV_ISI_ANS.key))
                .body("validationProcessBasicSignature.conclusion.errors.find { it.key == 'BBB_CV_ISI_ANS' }.value", equalTo(DssMessage.BBB_CV_ISI_ANS.message))

                .body("timestamps[0].validationProcessBasicTimestamp.constraint.name.key", hasItem(DssMessage.BSV_IISCRC.key))
                ...
                .body("timestamps[0].validationProcessBasicTimestamp.constraint.name.key", hasItem(DssMessage.BSV_IXCVRC.key))
                ...
                .body("timestamps[0].validationProcessBasicTimestamp.conclusion.errors.key", hasItem(DssMessage.BBB_CV_TSP_IRDOI_ANS.key))
                .body("timestamps[0].validationProcessBasicTimestamp.conclusion.errors.value", hasItem(DssMessage.BBB_CV_TSP_IRDOI_ANS.message))
                .body("timestamps[0].id", notNullValue())
                ...
                .body("timestamps[0].validationProcessArchivalDataTimestamp.conclusion.errors.key", hasItem(DssMessage.BBB_CV_TSP_IRDOI_ANS.key))
                .body("timestamps[0].validationProcessArchivalDataTimestamp.conclusion.errors.value", hasItem(DssMessage.BBB_CV_TSP_IRDOI_ANS.message))
                ...
                .body("validationProcessLongTermData.constraint.error.key", hasItem(DssMessage.LTV_ABSV_ANS.key))
                ...
                .body("validationProcessLongTermData.conclusion.errors.key", hasItem(DssMessage.BBB_XCV_SUB_ANS.key))
                .body("validationProcessLongTermData.conclusion.errors.find { it.key == 'BBB_XCV_SUB_ANS' }.value", equalTo(DssMessage.BBB_XCV_SUB_ANS.message))
                .body("validationProcessLongTermData.conclusion.errors.key", hasItem(DssMessage.BBB_XCV_ICTIVRSC_ANS.key))
    ...
    def "Given detailed report, then trust service warning is not filtered out"() {
        ...
        SivaRequests.validate(RequestData.validationRequest("validTsSignatureWithRolesAndProductionPlace.asice", null, ReportType.DETAILED))
                ...
                .body("conclusion.warnings.key[0]", hasItem(DssMessage.QUAL_IS_TRUST_CERT_MATCH_SERVICE_ANS2.key))
                .body("conclusion.warnings.value[0]", hasItem(DssMessage.QUAL_IS_TRUST_CERT_MATCH_SERVICE_ANS2.message))
    }
    ...
    def "Given detailed report, then lowest POE time error not filtered out"() {
        ...
        SivaRequests.validate(RequestData.validationRequest("IB-4183_3.4kaart_RSA2047_TS.asice", null, ReportType.DETAILED))
                ...
                .body(VALIDATION_PROCESS_TS_PREFIX + "validationTimestampQualification.conclusion.errors.key[0][0]", hasItem(DssMessage.QUAL_HAS_GRANTED_AT_ANS.key))
                .body(VALIDATION_PROCESS_TS_PREFIX + "validationTimestampQualification.conclusion.errors.value[0][0]", hasItem(DssMessage.QUAL_HAS_GRANTED_AT_ANS.message))
