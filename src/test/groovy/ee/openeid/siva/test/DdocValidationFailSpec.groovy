...
class DdocValidationFailSpec extends GenericSpecification {
    ...
    def "ddocInvalidMultipleSignatures"() {
        ...
        SivaRequests.validate(RequestData.validationRequest("multipleInvalidSignatures.ddoc"))
                ...
                .body("signatures[1].signatureFormat", Matchers.is(SignatureFormat.DIGIDOC_XML_1_1))
                .body("signatures[1].indication", Matchers.is(SignatureIndication.TOTAL_FAILED))
                .body("signatures[2].signatureFormat", Matchers.is(SignatureFormat.DIGIDOC_XML_1_1))
